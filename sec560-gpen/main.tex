...
\setmarginsrb{2.5cm}{1cm}{2.5cm}{1cm}{1,5cm}{0,5cm}{1cm}{1cm}
...
\newcommand{\book}[2]{ B#1:#2}		 % displays a code when using \book, e.g. BOOK2-17 for "Book 2 - page 17"
\newcommand{\lab}[1]{L#1 }						 % displays a code when using \lab, e.g. L3 for "Lab 3"
\newcommand{\workbook}[0]{WB }
